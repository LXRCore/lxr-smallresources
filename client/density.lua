--[[
    ...
    🐺 LXR Core - Small Resources | Density Control (Client)
    Controls ambient ped, animal, and vehicle traffic density multipliers.
...
local config = {
    pedFrequency     = Config.Density.pedFrequency,
    trafficFrequency = Config.Density.trafficFrequency,
    animalFrequency  = Config.Density.animalFrequency,
}
