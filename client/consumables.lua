--[[
    ...
    🐺 LXR Core - Small Resources | Consumables (Client)
    Handles eating, drinking, alcohol, and smoking animations and effects.
...
RegisterNetEvent("consumables:client:Drink", function(itemName)
    ...
    exports['lxr-core']:Progressbar("drink_something", "Drinking..", sleep, false, true, {
        disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", sharedItems[itemName], "remove")
		exports['lxr-hud']:UpdateStatus({thirst = ConsumeablesDrink[itemName]})
    end)
    ClearPedTasks(ped)
    AnimDetatch (sleep)
    isBusy = not isBusy
...
RegisterNetEvent("consumables:client:Smoke", function(itemName)
    ...
    exports['lxr-core']:Progressbar("smoking", "Smoking..", sleep, false, true, {
        disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", sharedItems[itemName], "remove")
		exports['lxr-hud']:UpdateStatus({stress = math.random(-40, -20)})
    end)
    ClearPedTasks(ped)
    AnimDetatch (sleep)
    isBusy = not isBusy
...
RegisterNetEvent("consumables:client:DrinkAlcohol", function(itemName)
    ...
    exports['lxr-core']:Progressbar("drink_alcohol", "Drinking liquor..", math.random(3000, 6000), false, true, {
        disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", sharedItems[itemName], "remove")
        TriggerServerEvent("LXRCore:Server:RemoveItem", itemName, 1)
		exports['lxr-hud']:UpdateStatus({thirst = ConsumeablesAlcohol[itemName]})
    end, function()
        exports['lxr-core']:Notify(9, "Cancelled..", 2000, 0, 'mp_lobby_textures', 'cross')
    end)
    Wait(sleep)
    if bottle ~= nil then
...
RegisterNetEvent("consumables:client:Eat", function(itemName)
    ...
    exports['lxr-core']:Progressbar("eat_something", "Eating..", 5000, false, true, {
        disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", sharedItems[itemName], "remove")
		exports['lxr-hud']:UpdateStatus({stress = math.random(-4, -2), hunger = ConsumeablesEat[itemName]})
    end)
    ClearPedTasks(ped)
    isBusy = not isBusy
end)

RegisterNetEvent("lxr:Dual", function()
